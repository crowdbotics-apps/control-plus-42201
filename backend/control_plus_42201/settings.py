"""
Django settings for control_plus_42201 project.
...
ROOT_URLCONF = 'control_plus_42201.urls'
...
WSGI_APPLICATION = 'control_plus_42201.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "control_plus_42201 API",
    "DESCRIPTION": "API documentation for control_plus_42201 App",
    "VERSION": "v1",
}
